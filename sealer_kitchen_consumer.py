...
class SEALER(object):
    def __init__(self):
        ...
        self.brown_raw_insert_query = """INSERT INTO sealer_brown(timestamp, status_of_drum, label, qrcode, text, presence_status, yolo_status) VALUES %s"""
        self.blue_raw_insert_query = """INSERT INTO sealer_blue(timestamp, status_of_drum, label, qrcode, text, presence_status, yolo_status) VALUES %s"""
        self.grey_raw_insert_query = """INSERT INTO sealer_grey(timestamp, status_of_drum, label, qrcode, text, presence_status, yolo_status) VALUES %s"""
    ...
    def raw_data_insert(self,json_string):
        ...
        data_row = (current_timestamp,label_present,qr_code_present,qr_value,grey_drum_present,blue_drum_present,brown_drum_present,no_drum_present) 
